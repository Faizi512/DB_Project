...
public class Q7Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            String q ="select c.Name,c.Address,m.Movie_Name,sum(t.Price)as Total_Sum\n" +
"from CINEMA c,MOVIE m,TICKET t,SCREEN s\n" +
"where t.Movie_ID=m.Movie_ID and s.Cinema_ID=c.ID and s.ID=t.Screen_ID\n" +
"group by c.Address,m.Movie_Name,c.Name\n" +
