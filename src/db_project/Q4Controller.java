...
public class Q4Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            String q = " \n" +
" select s.Cinema_ID,c.Name as Cinema_Name,m.Movie_Name,sum(t.Price)as Total_SUM\n" +
"from TICKET t,SCREEN s,CINEMA c,MOVIE m\n" +
"where t.Screen_ID=s.ID and s.Cinema_ID=c.ID and s.Movie_ID=m.Movie_ID\n" +
"group by s.Cinema_ID,c.Name,m.Movie_Name\n" +
